...
from ipmininet.router.config import BGP, ebgp_session, set_rr, AccessList, \
     AF_INET6, AF_INET, BorderRouterConfig, RouterConfig, OSPF, bgp_peering
...
class PARTopoDisabled(IPTopo):
    ...
    def build(self, *args, **kwargs):
        ...
        as3r5.addDaemon(BGP)
        as3r6 = self.bgp('as3r6')
        as3r6.addDaemon(OSPF, redistribute=[OSPFRedistributedRoute("bgp", 1, 15),])
        ...
        # Add iBGP peering
        self.addiBGPFullMesh(3, (as3r1, as3r2, as3r3, as3r4, as3r5, as3r6, as3r8,
                                 as3r9, as3r10))
...
if __name__ == '__main__':
    net = IPNet(topo=PARTopoDisabled())
    try:
        net.start()
        IPCLI(net)
    finally:
