...
from pyospf.core.ospfArea import OspfArea
from pyospf.core.ospfReceiver import OspfReceiver
from pyospf.core.ospfLsdb import OspfLsdb
...
class OspfInstance(object):
    ...
    def __new__(cls, config, topo_queue):
        if not cls._instance:
            cls._instance = object.__new__(cls)
        return cls._instance

    def __init__(self, config, topo_queue):
        ...
        self.area = OspfArea(self, topo_queue)
    ...
    def run(self):
        ...
        self._sock = OspfSock()
        self._sock.bind_ospf_multicast_group(self.interface_name)
